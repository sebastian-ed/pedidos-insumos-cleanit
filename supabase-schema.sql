...
create table if not exists public.orders(
  ...
  billing_reference_decision text check(billing_reference_decision is null or billing_reference_decision in('previous','current')),
  billing_reference_reviewed_service_billing numeric(14,2) check(billing_reference_reviewed_service_billing is null or billing_reference_reviewed_service_billing >= 0),
  billing_reference_reviewed_limit_percent numeric(5,2) check(billing_reference_reviewed_limit_percent is null or billing_reference_reviewed_limit_percent between 5 and 7),
  billing_reference_reviewed_at timestamptz,
  billing_reference_reviewed_by uuid references public.profiles(id) on delete set null,
...
-- ============================================================================
-- MODULO: CONTROL DE FACTURAS DE PROVEEDOR
-- ============================================================================
...
-- Referencia presupuestaria de pedidos existentes
